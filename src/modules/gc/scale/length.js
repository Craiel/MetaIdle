...
length_comparisons = {
	...
	// Displays: "If your swath of Goomies were laid end-to-end, they would stretch  {0}."
	
	"goomy": {
		"name_sing": "as far as one Goomy",
		"name_pl": "as far as {0} Goomies",
		"length": 0.2875
	},
	...
	"olympic_pool": {
		...
		"name_pl": "across {0} Olympic-sized swimming pools",
		"length": 25
	},
	
	"football_field": {
		"name_sing": "across a football field",
		"name_pl": "across {0} football fields",
		"length": 105
	},
	
	"cn_tower": {
		"name_sing": "as high as the CN Tower",
		"name_pl": " {0} times as high as the CN Tower",
		"length": 553.33
	},
	
	"walking": {
		"name_sing": "as far as a person can walk in 1 hour",
		"name_pl": "as far as a person can walk in {0} hours",
		"length": 4500
	},
	
	"gibraltar": {
		"name_sing": "across the Gibraltar Strait",
		"name_pl": "across the Gibraltar Strait {0} times",
		"length": 14795
	},
	
	"channel": {
		"name_sing": "across the English Channel",
		"name_pl": "across the English Channel {0} times",
		"length": 33100
	},
	
	"driving": {
		"name_sing": "as far as a car on a highway goes in an hour",
		"name_pl": "as far as a car on a highway goes in {0} hours",
		"length": 100000
	},
	...
	"iss_velocity": {
		...
		"name_pl": "the distance the International Space Station travels in {0} hours",
		"length": 27576000
	},
	
	"around_the_world": {
		"name_sing": "around the Earth",
		"name_pl": "around the Earth {0} times",
		"length": 40000000
	},
	
	"earth_orbit": {
		"name_sing": "the distance Earth orbits the Sun in one hour",
		"name_pl": "the distance Earth orbits the Sun in {0} hours",
		"length": 107280000
	},

	"light-second": {
		"name_sing": "the distance light travels in one second",
		"name_pl": "the distance light travels in {0} seconds",
		"length": 299792458
	},
	...
	"moon2": {
		...
		"name_pl": "to the Moon and back {0} times",
		"length": 800000000
	},
	...
	"light-minute": {
		...
		"name_pl": "the distance light travels in {0} minutes",
		"length": 17987547480
	},
	...
	"sun2": {
		...
		"name_pl": "to the Sun and back {0} times",
		"length": 299820000000
	},
	...
	"light-hour": {
		...
		"name_pl": "the distance light travels in {0} hours",
	...
	"light-day": {
		...
		"name_pl": "the distance light travels in {0} days",
		"length": 2.59e+13
	},
	...
	"light-year": {
		...
		"name_pl": "the distance light travels in {0} years",
		"length": 9.461e+15
	},
	...
	"light-millennium2": {
		"name_pl": "the distance light travels in {0} thousand years",
		"length": 9.461e+19,
	...
	"milky_way3": {
		...
		"name_pl": "across the Milky Way galaxy {0} times",
		"length": 9.461e+20
	},
	...
	"light-megayear": {
		...
		"name_pl": "the distance light travels in {0} million years",
		"length": 9.461e+21
	},
	...
	"andromeda2": {
		...
		"name_pl": "to the Andromeda Galaxy and back {0} times",
		"length": 4.865e+22
	},
	...
	"light-gigayear": {
		...
		"name_pl": "the distance light travels in {0} billion years",
		"length": 9.461e+24
	},
...
function compare_length(m){
	...
	if("length_base" in length_comparisons[largest_comparison]){
		...
		if(length_comparisons[largest_comparison].name_pl.indexOf("%d") != -1)
			return length_comparisons[largest_comparison].name_pl.format(Math.floor(comp_ratio));
		else
			return length_comparisons[largest_comparison].name_pl.format(comp_ratio.toFixed(1));
	}else{
